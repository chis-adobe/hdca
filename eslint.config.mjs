...
import xwalk from 'eslint-plugin-xwalk';
...
export default [
  ...
  // xwalk.configs.recommended uses the legacy plugin format; translate it inline for flat config
  {
    plugins: { xwalk },
    rules: {
  ...
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      'xwalk/max-cells': ['error', {
        ...
        hero: 8, // 4x2 layout: image, imageStyle, text, textStyle, cta, ctaStyle, (reserved), bgColour
      }],
